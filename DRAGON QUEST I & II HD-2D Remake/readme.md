...
- **Disable DOF**. This game has a weird DOF effect even on weird zones. Just look at the [COMPARISON HERE](https://imgsli.com/NDI1NjQ3). Come on ... WTF the devs are thinking?.
- **Disable AA (Anti-Aliasing)**. Character sprite should look more clean. (I DON'T KNOW IF IT'S WORKING OR NOT, CAN'T TAKE A PROPER COMPARISON SCREENSHOT. IF NOT, I'LL UPLOAD A CHEAT INSTEAD)
...
- **1.0.1 ONLY** | BuildID: 94B4FA4F36E01BE3 
